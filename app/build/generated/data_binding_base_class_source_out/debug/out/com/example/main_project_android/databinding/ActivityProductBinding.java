...
public final class ActivityProductBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvNameDish;

  private ActivityProductBinding(@NonNull LinearLayout rootView, @NonNull Button btnPayment,
      @NonNull TextView tvNameDish) {
  ...
  public static ActivityProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvNameDish;
      TextView tvNameDish = ViewBindings.findChildViewById(rootView, id);
      if (tvNameDish == null) {
        break missingId;
      }

      return new ActivityProductBinding((LinearLayout) rootView, btnPayment, tvNameDish);
    }
